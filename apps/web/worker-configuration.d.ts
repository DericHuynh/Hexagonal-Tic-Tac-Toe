/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 44fe1687adee954e8e453489f74bc69f)
// Runtime types generated with workerd@1.20260317.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/server");
    durableNamespaces: "GameSession" | "MatchmakingQueue";
  }
  interface Env {
    DB: D1Database;
    GAME_SESSION: DurableObjectNamespace<import("./src/server").GameSession>;
    MATCHMAKING_QUEUE: DurableObjectNamespace<import("./src/server").MatchmakingQueue>;
  }
}
